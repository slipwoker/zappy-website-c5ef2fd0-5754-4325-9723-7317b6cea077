        ...
        (async function() {
          try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
              ...
              body: JSON.stringify({
                websiteId: 'c5ef2fd0-5754-4325-9723-7317b6cea077',
                name: formData.name,
    ...
    "translations": {
      "en": {
        "consentModal": {
          ...
          "description": "h uses cookies to enhance your experience, analyze site usage, and assist in our marketing efforts. You can manage your preferences anytime.",
